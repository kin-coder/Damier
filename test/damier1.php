...
<body>
    ...
    <?php if (!empty($l) && !empty($c)) : ?>
        <div class="container">
            ...
            <input type="button" class="btn btn-success bouton" id="geeks" value="Image">
        </div>
    <?php endif; ?>
    <br>
    ...
    <div class="container">
        <div id="mcanvas">
            <div id="img" style="display:none;">
                ...
                <input type="button" class="btn btn-warning" value="Exporter" onclick="download_image()">
            </div>
        </div>
    </div>
    </div>
    ...
    <script>
        ...
        function download_image() {
            var canvas = document.getElementById("mcanvas");
             image = canvas[0].toDataURL('image/jpeg', 0.5);
